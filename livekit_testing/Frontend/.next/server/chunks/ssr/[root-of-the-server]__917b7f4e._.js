...
__turbopack_context__.s({
    ...
    "getOrigin": (()=>getOrigin),
    "transcriptionToChatMessage": (()=>transcriptionToChatMessage)
});
    ...
    if (CONFIG_ENDPOINT) {
        ...
        try {
            ...
            for (const [key, entry] of Object.entries(remoteConfig)){
                ...
                if (key in config && typeof config[key] === entry.type && typeof config[key] === typeof entry.value) {
...
{
__turbopack_context__.s({
    "ApplyThemeScript": (()=>ApplyThemeScript),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__917b7f4e._.js.map